...
\inferrule[\tiny {(Safe)}]
    {
    (KIND=vInsert, \nexists (\psi', vInsert) \in \Delta, \psi=\psi') \vee\ \\\\
...
\inferrule[\tiny {(Conditional)}]
    ...
    {\Gamma, \Lambda \vdash if\ e_1 \ then\ e_2 \ else\ e_3 :T, \Lambda '''}
    ...
    \inferrule[\tiny {(Application)}]
    {
     ...
     \Gamma, \Lambda \vdash e_2 : T_1, \Lambda'\\
     \Gamma, \Lambda' \vdash e_1 : T_1, \Lambda''
     }
    ...
    {\Gamma, \Lambda \vdash e_1 op e_2 : T, \Lambda'}
...
\inferrule[\tiny {(Edge Remove)}]
    ...
    {\Gamma, \Lambda \vdash eRemove\ e_1\ e_2 : Bool, \Lambda}
